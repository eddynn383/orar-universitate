...
export default async function ClassroomsPage({ searchParams }: ClassroomPageProps) {
            ...
            <div className="flex flex-col items-center border-b bg-primary-200 border-primary-300 padding-l p-6">
                <div className="flex flex-col md:flex-row gap-4 justify-between items-start md:items-end w-full max-w-7xl">
                    <div className="flex flex-col gap-2">
                        <H1 className="text-left text-2xl">Săli</H1>
                            ...
                            {filteredClassrooms.length === 0 && searchQuery ? (
                                <Empty>
                                    ...
                                    <EmptyContent>
                                        ...
                                        <EmptyDescription>Nu au fost găsite sali de clasa care să corespundă criteriilor "{searchQuery}"</EmptyDescription>
                                    </EmptyContent>
                                </Empty>
                            ) : (
                                <>
                                                            ...
                                                            <Card className="bg-primary-100 h-full p-0 hover:bg-brand-400/20 hover:border-brand-400 transition-colors cursor-pointer">
                                                                <CardContent className="h-full flex items-center justify-center p-0">
                                                                    <Button className="flex-col py-4 px-6 w-full h-full text-base" variant="text" size="L">
                                                                        <CirclePlus className="size-6" /> Adaugă sala de clasă
                                                                    </Button>
                                                                </CardContent>
                                                            </Card>
                                                        } />
