            ...
            <div className="flex flex-col items-center border-b bg-primary-200 border-primary-300 padding-l p-6">
                <div className="flex gap-4 justify-between w-full max-w-7xl">
                    <div className="flex flex-col gap-2">
                        <H1 className="text-left text-2xl">Cadre didactice</H1>
                        <P className="text-base [&:not(:first-child)]:mt-0">Gestionează cadrele didactice din platformă</P>
                    </div>
                                        ...
                                        filteredTeachers.length === 0 ? (
                                            <Empty>
                                                <EmptyHeader>
                                                    ...
                                                    <EmptyDescription>Nu ai adăugat încă niciun cadru didactic. Creează primul profil pentru a începe organizarea.</EmptyDescription>
                                                </EmptyHeader>
                                                <AdminOnlyServer>
                                                    <CreateTeacherModal trigger={
                                                        <Button variant="brand" size="L">
                                                            <CirclePlus className="size-4" />
                                                            Crează cadru didactic
                                                        </Button>
                                                    } />
                                                </AdminOnlyServer>
                                            </Empty>
                                                            ...
                                                            <Card className="bg-primary-100 h-full p-0 hover:bg-brand-400/20 hover:border-brand-400 transition-colors cursor-pointer">
                                                                <CardContent className="h-full flex items-center justify-center p-0">
                                                                    <Button className="flex-col py-4 px-6 w-full h-full text-base" variant="text" size="L">
                                                                        <CirclePlus className="size-6" /> Adaugă cadru didactic
                                                                    </Button>
                                                                </CardContent>
                                                            </Card>
                                                        } />
